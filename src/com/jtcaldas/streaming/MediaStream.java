...
import com.jtcaldas.streaming.rtp.AbstractPacketizer;
...
public abstract class MediaStream implements Stream {
	...
	public MediaStream() {
		...
		for (int i=0;i<10;i++) {
			try {
				...
				mLss = new LocalServerSocket("com.jtcaldas.librtp-"+mSocketId);
				break;
	...
	/**
	 * Returns the SSRC of the underlying {@link com.jtcaldas.streaming.rtp.RtpSocket}.
	...
	private void createSockets() throws IOException {
		...
		mReceiver.connect( new LocalSocketAddress("com.jtcaldas.librtp-" + mSocketId ) );
